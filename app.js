...
app.post("/home/news", function (request, response) {
	...
	response.send(`News: ${request.body.title} ${request.body.ymd}<br> has been inserted.`);
    ////顯示新增的資料屬性
})
...
app.put("/home/news", function (request, response) {
	...
	response.send(`has been updated to<br>${request.body.title} ${request.body.ymd}`);
    ////顯示變更的資料屬性
})
...
app.delete("/home/news", function (request, response) {
	...
	response.send(`News: ${request.body.title} ${request.body.ymd}<br> has been deleted.`);
    ////顯示刪除的資料屬性
})
